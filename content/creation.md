...
section kingdoms
  ...
  subtitle The same pattern, written into the structure of physical reality
  grid 1
    card
    ...
    card
      step Tzomeach · The Vegetative
      title Plant. Tree. All that grows.
      echo Echoes Phase II — the first response, the first reaching
    ...
    card
      step Chai · The Animate
      title Animal. Bird. Every living creature.
      echo Echoes Phase III — selfhood, inner experience
    ...
    card
      step Medaber · The Speaking
      title The Human.
      echo Echoes Phase IV — complete desire, the will to rule
...
section hunger
  title The Growing Hunger
  subtitle The five stages of desire — and the longing none of them can answer
  para
...
section maturing
  title The Maturing of the Creature
  subtitle The human arc — the same pattern, lived from the inside
  grid 1
    card
      step Birth
      svg.phase4
      echo Echoes Phase I · Domem
    ...
    card
      step The Assertion of Will
      echo Echoes Phase II · Tzomeach
    ...
    card
      step Giving to Receive
      echo Echoes Phase III · Chai
    ...
    card
      step Fully Formed Ego
      echo Echoes Phase IV · Medaber
    ...
    card
      step What You Are Meant to Become
      svg.phase5
      echo The mirror of the Creator
